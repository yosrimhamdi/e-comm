              ...
              <ul class="dropdown-menu animated bounceIn">
                ...
                <li>
                  ...
                  <ul class="menu sm-scrol">
                    ...
                    <li>
                      <a href="#">
                        <i class="fa fa-users text-danger"></i> Donec at nisi sit amet tortor commodo porttitor pretium
                        a erat.
                      </a>
                    </li>
                    <li>
      ...
      <div class="container-full">
        ...
        <section class="content">
          <div class="row">
            ...
            <div class="col-xl-6 col-12">
              <div
                class="box bg-info bg-img"
                style=""
              >
                <div class="box-body text-center">
                  <img
                    src="{{ url('/admin/images/trophy.png') }}"
                    class="mt-50"
                    alt=""
                  />
                  <div class="max-w-500 mx-auto">
                    <h2 class="text-white mb-20 font-weight-500">Best Employee Johen,</h2>
                    <p class="text-white-50 mb-10 font-size-20">You've got 50.5% more sales today. You've reached 8th
                      milestone, checkout author section</p>
                  </div>
                </div>
              </div>
              <div class="row">
                  ...
                  <div class="row no-gutters">
                    ...
                    <div class="col-md-6 col-12">
                      <div
                        ...
                        data-overlay="5"
                        style="background-image: url( {{ url('/admin/images/gallery/landscape7.jpg') }})"
                      >
                        <div class="box-header no-border">
                          <h4 class="box-title mb-0">
                            ...
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0 mr-20">
                                <div
                                  ...
                                  style="background-image: url( {{ url('/admin/images/gallery/creative/img-1.jpg') }})"
                                ></div>
                              </div>
                          ...
                          <td class="pl-0 py-8">
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0 mr-20">
                                <div
                                  class="bg-img h-50 w-50"
                                  style="background-image: url( {{ url('/admin/images/gallery/creative/img-2.jpg') }})"
                                ></div>
                              </div>
                          ...
                          <td class="pl-0 py-8">
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0 mr-20">
                                <div
                                  class="bg-img h-50 w-50"
                                  style="background-image: url( {{ url('/admin/images/gallery/creative/img-3.jpg') }})"
                                ></div>
                              </div>
                          ...
                          <td class="pl-0 py-8">
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0 mr-20">
                                <div
                                  class="bg-img h-50 w-50"
                                  style="background-image: url( {{ url('/admin/images/gallery/creative/img-4.jpg') }})"
                                ></div>
                              </div>
                          ...
                          <td class="pl-0 py-8">
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0 mr-20">
                                <div
                                  class="bg-img h-50 w-50"
                                  style="background-image: url( {{ url('/admin/images/gallery/creative/img-5.jpg') }})"
                                ></div>
                              </div>
        ...
        >
          ...
          <div class="media-list media-list-hover mt-20">
            ...
            <div class="media py-10 px-0">
              ...
              >
                <img
                  src="{{ url('/admin/images/avatar/2.jpg') }}"
                  alt="..."
                >
              </a>
              <div class="media-body">
            ...
            <div class="media py-10 px-0">
              <a
                class="avatar avatar-lg status-warning"
                href="#"
              >
                <img
                  src="{{ url('/admin/images/avatar/3.jpg') }}"
                  alt="..."
                >
              </a>
              <div class="media-body">
            ...
            <div class="media py-10 px-0">
              <a
                class="avatar avatar-lg status-primary"
                href="#"
              >
                <img
                  src="{{ url('/admin/images/avatar/4.jpg') }}"
                  alt="..."
                >
              </a>
              <div class="media-body">
