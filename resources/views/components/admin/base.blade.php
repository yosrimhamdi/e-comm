              ...
              <div class="box overflow-hidden pull-up">
                <div class="box-body">
                  ...
                  <div>
                    ...
                    <h3 class="text-white mb-0 font-weight-500">
                      1,700
                      <small class="text-success"><i class="fa fa-caret-up"></i> +0.5%</small>
                    </h3>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-6 col-12">
              <div class="box">
                <div class="box-header">
                  <h4 class="box-title">Earning Summary</h4>
                </div>
                      ...
                      <div class="box no-shadow mb-0">
                        <div class="box-body px-0">
                          ...
                          >
                            ...
                            <div>
                              <h5>Top Order</h5>
                              <h4 class="text-white my-0 font-weight-500">
                                $39k
                              </h4>
                            </div>
                          </div>
            ...
            <div class="col-xl-6 col-12">
              <div class="box bg-info bg-img">
                <div class="box-body text-center">
                  <img
                    src="{{ asset('/admin/images/trophy.png') }}"
                    class="mt-50"
                    alt=""
                  />
                  <div class="max-w-500 mx-auto">
                    <h2 class="text-white mb-20 font-weight-500">
                      Best Employee Johen,
                    </h2>
                    <p class="text-white-50 mb-10 font-size-20">
                      You've got 50.5% more sales today. You've reached 8th
                      milestone, checkout author section
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div class="box overflow-hidden">
                    <div class="box-body pb-0">
                      <div>
                        ...
                        <p class="text-mute mb-0 font-size-20">
              ...
              <div class="box overflow-hidden">
                <div class="box-body p-0">
                  <div class="row no-gutters">
                    <div class="col-md-6 col-12">
                      <div class="box no-shadow mb-0 rounded-0">
                        <div class="box-header no-border">
                          <h4 class="box-title mb-0">Last Posts</h4>
                        </div>
                        <div class="box-body p-0">
                          <div class="media-list media-list-hover">
                            <a
                              class="media media-single hover-white"
                              href="#"
                            >
                              <div class="media-body">
                                <h5>
                                  Meet Craftwork. Thoroghly Handpicked UI
                                  Freebies
                                </h5>
                              </div>
                            </a>
                    ...
                    <div class="col-md-6 col-12">
                      <div
                        class="box no-shadow mb-0 bg-img rounded-0"
                        data-overlay="5"
                        style="
                            background-image: asset( {{ asset('/admin/images/gallery/landscape7.jpg') }});
                          "
                      >
                        <div class="box-header no-border">
                        ...
                        <div class="box-body">
                          <div class="text-right mt-100 pt-20">
                            <h3 class="text-white">
                              <small class="mr-10"><i class="fa fa-commenting"></i></small>
                              3
                            </h3>
                            <h2 class="text-white">
                              <small class="mr-10"><i class="fa fa-heart"></i></small>
                              23
                            </h2>
                            <h1 class="text-white">
                              <small class="mr-10"><i class="fa fa-eye"></i></small>
                              189
                            </h1>
                          </div>
                        </div>
                            ...
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0 mr-20">
                                <div
                                  ...
                                  style="
                                      background-image: asset( {{ asset('/admin/images/gallery/creative/img-1.jpg') }});
                                    "
                                ></div>
                              </div>
                            ...
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0 mr-20">
                                <div
                                  class="bg-img h-50 w-50"
                                  style="
                                      background-image: asset( {{ asset('/admin/images/gallery/creative/img-2.jpg') }});
                                    "
                                ></div>
                              </div>
                            ...
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0 mr-20">
                                <div
                                  class="bg-img h-50 w-50"
                                  style="
                                      background-image: asset( {{ asset('/admin/images/gallery/creative/img-3.jpg') }});
                                    "
                                ></div>
                              </div>
                            ...
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0 mr-20">
                                <div
                                  class="bg-img h-50 w-50"
                                  style="
                                      background-image: asset( {{ asset('/admin/images/gallery/creative/img-4.jpg') }});
                                    "
                                ></div>
                              </div>
                            ...
                            <div class="d-flex align-items-center">
                              <div class="flex-shrink-0 mr-20">
                                <div
                                  class="bg-img h-50 w-50"
                                  style="
                                      background-image: asset( {{ asset('/admin/images/gallery/creative/img-5.jpg') }});
                                    "
                                ></div>
                              </div>
